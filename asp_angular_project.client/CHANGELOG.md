...
- Create Angular project with ng: `ng new asp_angular_project.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`asp_angular_project.client.esproj`).
